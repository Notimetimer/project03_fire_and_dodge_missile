from CombatPPOWithIL3_parallel2debug import *
from datetime import datetime

mission_name = '纯策略蒸馏debug'
...
alpha_il = 100  # 2 1e-2  # 设置为0就是纯强化学习
...
max_episode_duration = 12.5*60  # 10*60 # 回合最长时间，单位s
R_cage= 45e3 # 55e3 # 场地半径，单位m
dt_action_cycle = dt_maneuver * action_cycle_multiplier
transition_dict_threshold = 0 # 5 * max_episode_duration//dt_action_cycle + 1  # debug
