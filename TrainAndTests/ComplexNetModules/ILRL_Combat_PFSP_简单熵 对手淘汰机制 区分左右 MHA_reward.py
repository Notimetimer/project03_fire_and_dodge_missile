...
from Envs.Tasks.ChooseStrategyEnv2_3 import *
# from Algorithms.MLP_heads import ValueNet
# from Algorithms.PPOHybrid23_0 import PPOHybrid, PolicyNetHybrid, HybridActorWrapper
from Algorithms.PPOHybrid23_0_3 import PPOHybrid, ValueNet, PolicyNetHybrid, HybridActorWrapper, RewardWeightAttentionNet
...
reward_att_net = RewardWeightAttentionNet(
    obs_dim=state_dim, 
    num_dense_rewards=num_dense_rewards
).to(device)
