...
if __name__=='__main__':
    ...
    # state_dim = env.obs_dim  # len(b_obs_spaces)
    ...
    try:
        ...
        il_pkl_path = os.path.join(il_dir, "il_transitions_combat.pkl")
        trans_pkl_path = os.path.join(il_dir, "transition_dict_combat.pkl")
