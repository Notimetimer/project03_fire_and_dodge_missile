...
resume_target_dir = r"D:\3_Machine_Learning_in_Python\project03_fire_and_dodge_missile\logs\combat\IL_and_Pure经典PFSP_多技术流派_并行_分层_rule3_0.3_3类-run-20260524-174414"
collape_recover={ # 是否是崩盘后恢复 
            "collapsed": False,
            "best_actor_name": None,
            "actor_frozen_batchs": 5,
        }
mission_name = 'IL_and_Pure经典PFSP_多技术流派_并行_分层_rule3_0.3_3类'
...
if __name__=='__main__':
    ...
    run_MLP_simulation(
        ...
        self_play_type = 'PFSP_double_dims', # PFSP_balanced, PFSP_challenge, FSP, SP, None 表示非自博弈
