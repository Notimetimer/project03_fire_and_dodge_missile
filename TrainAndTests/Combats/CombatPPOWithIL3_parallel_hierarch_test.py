        ...
        while True:
            ...
            if cmd == 'RUN_EPISODE':
                ...
                for count in range(max_counts):
                    ...
                    b_m_id = launch_missile_immediately(env, 'b', action_label=r_action_label) if getattr(env.BUAV, 'about_to_fire', 0) else None
                    r_m_id = launch_missile_immediately(env, 'r', action_label=b_action_label) if getattr(env.RUAV, 'about_to_fire', 0) else None
