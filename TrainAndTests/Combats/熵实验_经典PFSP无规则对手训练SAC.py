...
# [SAC] 使用 SAC 版本的训练主模块
from CombatSACWithIL3_parallel_hierarch import *
...
mission_name = f'SAC0_flymask_v{ver}h{hor}'
...
beta_mixed = 1.0
label_smoothing=0.05 # 0.2 # 0.3 改为 1-0.4，而p1=0.4对应3.4附近的策略熵
