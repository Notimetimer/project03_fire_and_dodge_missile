...
from Algorithms.PPOHybrid23_1 import PPOHybrid, PolicyNetHybrid, HybridActorWrapper
from Algorithms.MLP_heads import ValueNet
from Visualize.tensorboard_visualize import TensorBoardLogger
from BasicRules import *
from Envs.Tasks.ChooseStrategyEnv21 import *
...
# k_entropy={'cont':0.01, 'cat':0.01, 'bern':0.05} # 1 # 0.05 12.15 17:58分备份
...
if __name__ == "__main__":
    ...
    mission_name = 'RL_combat_PFSP_SAC熵'
    ...
    pre_train_latest_log_dir = get_latest_log_dir(pre_train_logs_root_dir, "ILRL_combat_打rule0带导弹")
