...
from Algorithms.PPOHybrid23_0_BC import PPOHybrid, PolicyNetHybrid, HybridActorWrapper
...
def run_MLP_simulation(
    ...
    # 能够被 BC_update 里的 items() 正常遍历
    for epoch in range(IL_epoches): 
        avg_actor_loss, avg_critic_loss, c = student_agent.BC_update(
