...
resume_target_dir = r"D:\3_Machine_Learning_in_Python\project03_fire_and_dodge_missile\logs\combat\noIL_and_deltaFSP_挑战_并行_分层2s-run-20260413-175003"
mission_name = 'noIL_and_deltaFSP_挑战_并行_分层2s'
...
epochs = 4 # 10
eps = 0.2
k_entropy={'cont':0.01, 'cat':0.008, 'bern':0.001} # 1 # 0.01也太大了
