...
# resume_target_dir = r"D:\3_Machine_Learning_in_Python\project03_fire_and_dodge_missile\logs\combat\IL_and_Mixed经典PFSP_挑战_并行_分层_训练圆分布-run-20260510-161932"
...
mission_name = 'Circular0.3'

# 超参数
actor_lr = 1e-4 # 4 1e-3
critic_lr = actor_lr * 5 # * 5
IL_epoches= 30
max_steps = 10e6 # 1320e4
hidden_dim = [128, 128, 128]
gamma = 0.995
lmbda = 0.995
epochs = 4 # 10
eps = 0.2
k_entropy={'cont':0.01, 'lin':0.005, 'bern':0.003, 'circ':0.005} # cat:0.005, bern:0.001 是常数熵系数几乎完美的设定值。
