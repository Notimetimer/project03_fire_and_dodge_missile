...
from Envs.Tasks.ChooseStrategyEnv4 import *
...
if __name__ == "__main__":
    ...
    mission_name = '重新设计动作空间打rule0带导弹'
    ...
    action_cycle_multiplier = 5
    dt_action_cycle = dt_maneuver * action_cycle_multiplier  # 1s
    ...
    while total_steps < int(max_steps):
        ...
        for count in range(round(args.max_episode_len / dt_maneuver)):
            ...
            b_maneuver = env.maneuver16(env.BUAV, b_action_label)
