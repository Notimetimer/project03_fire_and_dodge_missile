...
resume_target_dir = r"D:\3_Machine_Learning_in_Python\project03_fire_and_dodge_missile\logs\combat\IL_and_Pure经典PFSP_挑战_并行_分层_rule3_0.01-run-20260521-222513"

mission_name = 'IL_and_Pure经典PFSP_挑战_并行_分层_rule3_0.01'
...
beta_mixed = 1.0
label_smoothing=0.01 # 0.2 # 0.3 改为 1-0.4，而p1=0.4对应3.4附近的策略熵
