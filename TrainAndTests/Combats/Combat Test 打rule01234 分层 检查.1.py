...
if __name__ == "__main__":
    ...
    dir_name = "SLWS-PFSP-run-20260618-221044" # "SLWSPFSP0.3-run-20260704-175531" # "无预训练-run-20260814-105541"  # "无预训练-run-20260817-225310"# "Adistill_NoIL-run-20260815-223725" # "TD3_PFSP_0.3-run-20260809-155629" # "SLWSPFSP0.3-run-20260804-221605"
