...
from Algorithms.PPOcontinues_std_no_state_with_truncs_with_Channel_Attention import *
...
if __name__ == "__main__":
    ...
    agent = PPOContinuous(state_dim, reduction_ratio, hidden_dim, action_dim, actor_lr, critic_lr,
