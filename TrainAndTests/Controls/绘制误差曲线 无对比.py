...
plot_comparison(ax1, [df1], 'psi', ['RL', 'PID'], is_error=True, req_col='psi_req')
...
plot_comparison(ax2, [df1], 'theta', ['RL', 'PID'], req_col='theta_req')
...
plot_comparison(ax3, [df1], 'v', ['RL', 'PID'], req_col='v_req')
...
# plot_comparison(ax4, [df1], 'h', ['RL', 'PID'], req_col='h_req')
# ax4.set_title("高度 (Altitude) 跟踪对比")
# ax4.set_ylabel("Height (m)")
# ax4.legend(); ax4.grid(True)

plt.suptitle(f"控制器性能\n: {file_name}", fontsize=12)
