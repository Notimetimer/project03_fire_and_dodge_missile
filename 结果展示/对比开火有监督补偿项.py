...
# 配置 exp_csv 路径（开火监督补偿项对比：开火头RL+SL / 开火头仅RL / 开火头仅SL）
EXP_CSV_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), "exp_csv2")
...
if __name__ == "__main__":
    ...
    # ==================== 3. 视觉样式设置（可在此调节） ====================
    SMOOTH_WINDOW = 31    # 平均曲线的滑动平均平滑窗口大小（推荐 51 ~ 101，数值越大越平滑，<=1 不平滑）
