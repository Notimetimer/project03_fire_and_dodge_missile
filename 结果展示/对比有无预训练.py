...
# 配置 exp_csv 路径（有无预训练对比：无预训练-PPO / 预训练-PPO）
EXP_CSV_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), "exp_csv1")
...
if __name__ == "__main__":
    ...
    SAVE_BASE_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), "对比有无预训练")
    ...
    plot_interpolated_win_rates(
        ...
        invert_y=INVERT_Y,
        include_mutualkill=False,   # exp_csv1 中无 mutualkill 数据，置 False 避免生成空图
        mutualkill_label="对基准对手平均双杀率",
